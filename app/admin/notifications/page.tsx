...
export default function NotificationsPage() {
  ...
  const handleCardClick = (notification: Notification) => {
    ...
    if (notification.jobSlug) {
      router.push(`/admin/jobs/${notification.jobSlug}`);
    }
  };
        ...
        <div className="card p-12 text-center">
          ...
          <p className="text-sm" style={{ color: "#94A3B8" }}>
            {searchQuery || typeFilter !== "all" || dateFrom || dateTo
              ...
              : "Notifikasi akan muncul saat ada aktivitas job"}
          </p>
          {(searchQuery || typeFilter !== "all" || dateFrom || dateTo) && (
            <button
              onClick={() => {
            ...
            <div key={group.date}>
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-xs text-slate-400">
                  {group.notifications.length} notifikasi
                </span>
              </div>
                ...
                {group.notifications.map((n) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        borderLeftColor: !n.isRead ? config.color : undefined,
                      }}
                    >
