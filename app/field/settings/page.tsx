...
export default function FieldSettingsPage() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-xl mx-auto" style={{ background: "#F8FAFC", minHeight: "calc(100vh - 80px)" }}>
        ...
        <form onSubmit={handleSaveProfile} className="space-y-3 sm:space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-slate-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-amber-600 text-slate-900"
